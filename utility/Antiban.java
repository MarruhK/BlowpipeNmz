...
public class Antiban
{
    ...
    */
    ...
    public void timedActions()
    {
        ...
        {
            System.out.println("Antiban - Timed Actions: shouldLeaveGame initiated.");
            abcInstance.leaveGame();
        }

        if (abcInstance.shouldCheckTabs())
        {
            System.out.println("Antiban - Timed Actions: shouldCheckTabs initiated.");
            abcInstance.checkTabs();
        }

        if (abcInstance.shouldCheckXP())
        {
            System.out.println("Antiban - Timed Actions: shouldCheckXP initiated.");
            abcInstance.checkXP();
        }

        if (abcInstance.shouldExamineEntity())
        {
            System.out.println("Antiban - Timed Actions: shouldExamineEntity initiated.");
            abcInstance.examineEntity();
        }

        if (abcInstance.shouldMoveMouse())
        {
            System.out.println("Antiban - Timed Actions: shouldMoveMouse initiated.");
            abcInstance.moveMouse();
        }

        if (abcInstance.shouldPickupMouse())
        {
            System.out.println("Antiban - Timed Actions: shouldPickUpMouse initiated.");
    ...
    */
    ...
    public void executeShouldHoverAndMenu(RSObject nextTarget)
    {
        ...
        {
            // System.out.println("Antiban - Action Conditions: executeShouldHoverAndMenu initiated. Hovering Entity.");
            nextTarget.hover();
            if (this.shouldOpenMenu)
            {
                System.out.println("Antiban - Action Conditions: executeShouldHoverAndMenu initiated. Opening Menu.");
                Mouse.click(3);
            }
        }
    }
    ...
    public void generateTrackers(int est_waiting, boolean isUnderAttack)
    {
        ...
        // Actual generation
        System.out.println("Antiban - Reaction Times: generateTrackers initiated.");
