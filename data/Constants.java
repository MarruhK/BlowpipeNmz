...
public class Constants
{
    ...
    {
        COMBAT_POTION_MAPPINGS.put(ID_RANGING_POTIONS, "Ranging Potions");
        COMBAT_POTION_MAPPINGS.put(ID_SUPER_RANGING_POTIONS, "Super Ranging Potions");
    ...
    {
        initializeWeaponStyles(BLOWPIPE_IDS, AttackStyles.RANGE, AttackStyles.RANGE, AttackStyles.NONE, AttackStyles.LONGRANGE);
